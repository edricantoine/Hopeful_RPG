...
public class WastelandSentry extends Enemy{
    public WastelandSentry() {
        super("SEN-3", 500, 100, new ArrayList<>(Arrays.asList(
                        ...
                        new AttackSkill("Bayonet Stab", " stabbed with a sharp edge.", 0, "one", 40,
                                StatusEffect.NONE, 1.0, 1.0, 1),
                        new SupportSkill("Shields Up", " held up a metal shield.", 0, "one",
                                0, 0, 1.0, 2.00, false),
                        new SupportSkill("Robotic Immunity", " ran an antivirus program...? SEN-3 was cured of status effects?!",
                                0, "one",
                                0, 0, 1.0, 1.00, true)
